...
var handleVisitorsDonutChart = function() {
    var visitorDonutChartData = [
        { 'label': 'Producto o Servicio #1', 'value': 784466, 'color': COLOR_BLUE },
        { 'label': 'Producto o Servicio #2', 'value': 416747, 'color': COLOR_GREEN }
    ];
    var arcRadius = [
