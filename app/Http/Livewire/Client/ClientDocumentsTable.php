...
class ClientDocumentsTable extends LivewireDatatable
{
    public $hideable = 'select';
    public $exportable = true;
    public $activeDateFilters = true;
        ...
        if (Auth::user()->currentTeam->plan_id != 1) {
            return [
                ...
                Column::raw('(CASE 
                    ...
                    ->label('Tipo')
                    ->filterable(["Proforma", "Orden de Venta", "Factura Interna", "Factura Electronica", "Tiquete Electronico", "Nota Electronica Debito", "Nota Electronica Credito", 'Factura Electronica Exportacion'])
                    ->unwrap()
                    ->sortable()
                    ->alignCenter(),
