...
class ChartCostsByMonthComponent extends Component
{
    //Inicializa la variable de datos 
    public $cxc_data = [], $business_data = [], $months = [], $allMonths = [];
    public $chartDataCosts, $product = null, $ano = null, $families = null, $clients = null, $categories = null;
    protected $listeners = ['updatedMonthsCosts'];
    ...
    public function render()
    {
        ...
        return view('livewire.charts.chart-costs-by-month-component');
    }
    // se ejecuta cada vez que hay una seleccion de mes
    public function updatedMonthsC($value)
    {
        $this->months = $value;
        $this->loadChartData();
    }
    ...
    {
        $this->dispatchBrowserEvent('renderChartCosts', [
