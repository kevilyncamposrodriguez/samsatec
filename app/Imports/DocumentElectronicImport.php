...
class DocumentElectronicImport implements ToCollection, WithHeadingRow, WithProgressBar, WithValidation, WithUpserts, WithCalculatedFormulas, WithMultipleSheets
{
    use Importable;
