<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade " id="buyerUModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Actualizar de Comprador</h5>
    ...
    <script>
        window.addEventListener('buyerU_modal_hide', event => {
            $('#buyerUModal').modal('hide');
        });
    </script>
</div>