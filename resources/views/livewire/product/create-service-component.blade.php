<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade " id="serviceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 1060;">
                    ...
                    <form class="form-horizontal form-bordered">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <input class="form-control" type="text" name="cabys" list="cabiesU" placeholder="Ninguno" wire:model="cabys">
                                <datalist id="cabiesU" data-size="100">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <label class="col-lg-12">Costo por servicio: <span class="text-danger"></span></label>
...
<script>
    window.addEventListener('service_modal_hide', event => {
