<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade " id="productModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 1060;">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-bordered">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <select {{ (Auth::user()->hasTeamRole(Auth::user()->currentTeam, 'admin'))?'':'disabled' }} class="form-control" {{(Auth::user()->currentTeam->bo_inventory)?'':'disabled'}} data-size="10" data-live-search="true" name="id_count_inventory" id="id_count_inventory" wire:model="id_count_inventory">
...
<script>
    window.addEventListener('product_modal_hide', event => {
