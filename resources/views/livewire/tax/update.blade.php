...
<!-- Modal -->
<div wire:ignore.self class="modal fade" id="taxUModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Actualización de impuestos</h5>
...
<script>
    window.addEventListener('taxU_modal_hide', event => {
        $('#taxUModal').modal('hide');
    });
</script>
