...
<!-- Modal -->
<div wire:ignore.self class="modal fade" id="familyModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Creación de familia</h5>
...
<script>
    window.addEventListener('family_modal_hide', event => {
