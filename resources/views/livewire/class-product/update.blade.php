<!-- Modal -->
<div wire:ignore.self class="modal fade" id="classUModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Actualización de Clases de producto</h5>
            ...
            <div class="modal-body">
                <form class="form-horizontal form-bordered">
                    ...
                    <div class="form-group row m-b-10">
                        ...
                        <div class="col-3">
                            <input disabled class="form-control" type="text" name="symbol" wire:model="symbol" step="2" />
                        </div>
...
<script>
    window.addEventListener('classU_modal_hide', event => {
        $('#classUModal').modal('hide');
    });
</script>