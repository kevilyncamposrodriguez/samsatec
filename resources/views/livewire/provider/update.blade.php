<!-- Modal -->
<div wire:ignore.self class="modal fade" id="providerUModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <form class="form-horizontal form-bordered">
                    ...
                    <div class="form-group row m-b-10">
                        ...
                        <div class="col-lg-9 col-xl-9">
                            <div class="row row-space-6">
                                <div class="col-6">
                                    <input class="form-control" type="text" name="name_country_code" list="countryCodesU" placeholder="Ninguno" wire:model="name_country_code">
                                    <datalist id="countryCodesU">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <div class="row row-space-10">
                                <div class="col-xs-6">
                                    <input class="form-control" type="text" name="name_currency" list="currenciesU" placeholder="Ninguno" wire:model="name_currency">
                                    <datalist id="currenciesU">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                        <div class="panel panel-inverse">
                            ...
                            @if(count($allProviderAccountsU)>0)
                            <!-- begin panel-body -->
                            <div class="panel-body">
                                <table id="data-table-pay" class="table table-striped table-bordered table-td-valign-middle">
                                    ...
                                    <tbody>
                                        @foreach($allProviderAccountsU as $index => $accounts)
                                        <tr class="gradeU">
                                            <td width="15%" class="text-center">
                                                <div class="btn-group btn-group-justified">
                                                    <button wire:click.prevent="deleteAccountsU('{{ $accounts->id }}')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                                                </div>
                                            </td>
...
<script>
    window.addEventListener('providerU_modal_hide', event => {
        $('#providerUModal').modal('hide');
    });
</script>