...
<!-- Modal -->
<div wire:ignore.self class="modal fade" id="exonerationUModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Actualización de exoneracion</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:click.prevent="update()" onclick="this.disabled=true;" class="btn btn-primary">Actualizar</button>
            </div>
        </div>
    </div>
</div>
<script>
    window.addEventListener('exonerationU_modal_hide', event => {
        $('#exonerationUModal').modal('hide');
    });
</script>
