        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Pagos de Facturas</h5>
                ...
                <div class="modal-body">
                    <form class="form-horizontal form-bordered">
                        ...
                        <div class="form-group row ">
                            ...
                            <label class="col-lg-2 col-form-label">Proveedor: <span class="text-danger"></span></label>
                            <div class="col-5">
                                <input class="form-control" type="text" disabled name="provider" wire:model="provider" />
                                @error('provider') <span class="text-red-500">{{ $message }}</span>@enderror
                            </div>
                        </div>
                        <!-- end form-group -->
                        <!-- begin form-group -->
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-4">
                                <input data-toggle="number" class="form-control" type="number" name="mount" wire:model="mount" placeholder="Monto" />
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-3">
                                @if(!$isUpdatePay)
                                <button type="button" {{ ($mount<=0)?'disabled':'' }} title="Nuevo Pago" wire:click.prevent="storePay()" onclick="this.disabled=true;" class="btn btn-blue col-12">Agregar Pago</button>
                                @else
