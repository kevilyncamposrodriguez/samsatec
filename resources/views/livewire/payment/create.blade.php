            ...
            <div class="modal-body">
                <form class="form-horizontal form-bordered">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-8">
                            <select class="form-control" name="id_expense" wire:model="id_expense">
                                <option style="color: black;" value="">Ninguna</option>
                                @foreach($allExpenses as $expense)
                                <option style="color: black;" value="{{ $expense->id }}">{{ $expense->consecutive.'-'.$expense->name_provider }}</option>
                                @endforeach
                            </select>
                            @error('id_expense') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                    <!-- end form-group -->
                    <!-- begin form-group -->
