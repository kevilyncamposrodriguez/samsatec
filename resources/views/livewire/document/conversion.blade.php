            ...
            <div class="modal-body">
                <form id="import_v" class="form-horizontal form-bordered">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9 col-xl-9">
                            <select class="form-control" name="e_a" id="e_a" wire:model="e_a">
                                @foreach($allEAs as $ea)
                                <option active style="color: black;" value="{{ $ea->number }}">{{ $ea->name_ea }}</option>
                                @endforeach
                            </select>
                        </div>
                        @error('e_a') <span class="text-red-500">{{ $message }}</span>@enderror
                    </div>
                    <!-- end form-group -->
                    <!-- begin form-group -->
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Categoría MH: <span class="text-danger"></span></label>
                        <div class="col-lg-9 col-xl-9">
