                     ...
                     <div class="invoice">
                         ...
                         <div class="invoice-header p-t-10 p-b-10 row">
                             ...
                             <div class="col-md-4">
                                 ...
                                 <input class="form-control" type="date" name="delivery_date" id="delivery_date" wire:model="delivery_date" />
                             </div>
                             @endif
                             @if(Auth::user()->currentTeam->plan_id != 1 && Auth::user()->currentTeam->plan_id != 2)
                             <div class="col-md-4">
                             ...
                             <div class="panel-body panel-form">
                                 <div class="row">
                                     <div class="col-lg-6">
                                         ...
                                         <div class="input-group">
                                             <input class="form-control" autofocus type="text" name="name_product" id="name_product" wire:change="changeProduct()" list="products" placeholder="Ninguno" wire:model="name_product">
                                     ...
                                     <div class="col-lg-2">
                                         ...
                                         <input class="form-control" type="number" name="qty" min="0" wire:change="changeQty()" id="qty" value="1" placeholder='0.00' wire:model="qty" />
                                         @error('qty') <span class="text-red-500">{{ $message }}</span>@enderror
                                     </div>
                                     <div class="col-lg-2">
                                         <strong>Precio</strong>
                                         <input class="form-control" type="number" min="0" wire:change="changePrice()" name="price" id="price" placeholder='0.000000' wire:model="price" />
                                         @error('price') <span class="text-red-500">{{ $message }}</span>@enderror
                                     </div>
                                     <div class="col-lg-2">
                                         <strong>Costo</strong>
                                         <input class="form-control" type="number" name="cost" id="cost" step='0.00001' placeholder='0.000000' wire:model="cost" />
                                 ...
                                 <table class="table table-invoice" id="DetalleServicio" name="DetalleServicio">
                                     ...
                                     <tbody>
                                         ...
                                         <tr class="gradeU">
                                             ...
                                             <td width="7%" class="text-center">{{ bcdiv($line['qty'], '1', 2) }}</td>
                                             <td width="7%" class="text-center">{{ bcdiv($line['price'], '1', 2) }}</td>
                                             <td width="7%" class="text-center">{{ bcdiv($line['discount'], '1', 2) }}</td>
                                             <td width="7%" class="text-center">{{ bcdiv((isset($line['tax']['mount']))?$line['tax']['mount']:0 , '1', 2)}}</td>
                                             <td width="7%" class="text-center">{{ bcdiv((isset($line['tax']['exoneration']['AmountExoneration']))?$line['tax']['exoneration']['AmountExoneration']:0  , '1', 2)}}</td>
                                             <td width="7%" class="text-center">{{ bcdiv($line['totalLine']  , '1', 2)}}</td>
                                         </tr>
                                         @endforeach
                                     </tbody>
                                 </table>
                                         ...
                                         <table class="table table-other" id="DetalleOtherServicio" name="DetalleOtherServicio">
                                             ...
                                             <tbody>
                                                 ...
                                                 <tr class="gradeU">
                                                     ...
                                                     <td width="10%" class="text-center">{{ bcdiv($charge['amount_other'], '1', 2) }}</td>
                                                 </tr>
                                                 @endforeach
                                             </tbody>
                                         </table>
                                             ...
                                             <div class="invoice-price-row">
                                                 <div class="sub-price">
                                                     ...
                                                     <span class="text-inverse" id="sub_total">
                                                         <h5>{{ bcdiv($total_other_charges, '1', 2) }}</h5>
                                                     </span>
                                                 </div>
                                                 <div class="sub-price">
                                                 ...
                                                 <div class="sub-price">
                                                     ...
                                                     <span class="text-inverse" id="total_discount">
                                                         <h5>{{ bcdiv($total , '1', 2) }}</h5>
                                                     </span>
                                                 </div>
                                             </div>
                                         </div>
                                         <div class="invoice-price-right" style="background-color: #192743;">
                                             <small>TOTAL DOCUMENTO</small> <span class="f-w-600" id="total_invoice">{{ bcdiv(($total_other_charges+$total), '1', 2) }}</span>
                                         </div>
                                     </div>
                                     <!-- end invoice-price -->
                                 </div>
                         ...
                         <div class="invoice-price">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="sub-price text-small col-md-2">
                                         ...
                                         <span class="text-inverse text-small">
                                             <h4>{{ bcdiv($totalExoneration , '1', 2)}}</h4>
                                         </span>
                                     </div>
                                 </div>
                             </div>
                             <div class="invoice-price-right" style="background-color:#192743;">
                                 <div>
                                     ...
                                     <input class="form-control m-t-40" type="text" disabled style="font-size: 17pt; width: 200px; text-align:right" value="{{ bcdiv(($total_other_charges+$total), '1', 2) }}" />
                                 </div>
                             </div>
                         </div>
                         ...
                         <div class="invoice-price" style="margin-top: -20px;">
                             <div class="invoice-price-right" style="background-color:#192743;">
                                 <div>
                                     ...
                                     <input class="form-control m-t-40" type="text" disabled style="font-size: 17pt; width: 200px; text-align:right" size="20" name="vuelto" id="vuelto" value="{{ bcdiv((($cash != '')?$cash-$total:0), '1', 2) }}" />
                                 </div>
                             </div>
                         </div>
                         <!-- end invoice-price -->
