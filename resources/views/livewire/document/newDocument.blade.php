<!-- Modal -->
<div wire:ignore.self class="modal modal-message fade" id="document2Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="panel-body panel-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 m-t-10">
                                        <button type="button" wire:click.prevent="addLine()" class="btn btn-blue col-lg-12" accesskey="s" style="white-space: nowrap;">Agregar Linea</button>
                                    </div>
                                </div>
                            </div>
                            <!-- end panel-body -->
                                ...
                                <table class="table table-invoice" id="DetalleServicio" name="DetalleServicio">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td width="7%" class="text-center">{{ bcdiv($line['totalLine']  , '1', 2)}}k</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                            ...
                            <div class="col-lg-12">
                                <div class="invoice-price row">
                                    ...
                                    <div class="invoice-price-right col-4" style="background-color:#192743;">
                                        <small>TOTAL</small> <span class="f-w-600">{{ bcdiv($total, '1', 2) }}</span>
                                    </div>
                                </div>
                            </div>
                            <!-- end invoice-price -->
