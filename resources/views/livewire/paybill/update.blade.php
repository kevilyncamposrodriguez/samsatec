<!-- Modal -->
<div wire:ignore.self class="modal fade " id="paybillUModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form class="form-horizontal form-bordered">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label">Cedula: <span class="text-danger"></span></label>
                        <div class="col-lg-4 col-xl-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-4" wire:ignore>
                            <select class="form-control " name="id_count" id="id_countU">
...
<script>
    window.addEventListener('payBillU_modal_hide', event => {
        $('#paybillUModal').modal('hide');
    });
    document.addEventListener('DOMContentLoaded', function() {
        $('#id_countU').select2();
        $('#id_countU').on('change', function(e) {
            livewire.emit('changeCount', $('#id_countU').select2("val"))
        });
    });
    //manejo de clientes
    window.addEventListener('count-updated', event => {
        $("#id_countU").select2().val(event.detail.newValue).trigger('change.select2');
    })
</script>