        ...
        <div class="modal-dialog">
            <div class="modal-content" style="background-color: #E1E6E4;">
                        ...
                        <div class="invoice">
                            ...
                            <div class="invoice-header m-l-10  m-r-10 p-t-10 p-b-10 row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <label class="{{ ($priority == 1)?'text-green':(($priority == 2)?'text-yellow':'text-red') }}"><strong> {{ ($priority == 1)?'Baja':(($priority == 2)?'Media':'Alta')}} </strong> </label>
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="invoice-content">
                                ...
                                @error('qtys.*') <span class="text-red-500"><strong> No se permiten lineas vacías</strong></span>@enderror
                                    ...
                                    <table class="table table-invoice" id="DetalleServicio" name="DetalleServicio">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeU">
                                                ...
                                                <td width="5%" class="text-center">{{ $line['sku'] }}</td>
                                                <td width="5%" class="text-center">{{ $line['qty'] }}</td>
                                                <td width="15%" class="text-center"><input class="form-control" type="number" wire:model="qtys.{{ $index }}">
                                                <td width="35%" class="text-center"><input class="form-control" type="text" wire:model="notes.{{ $index }}">
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="processed()" onclick="this.disabled=true;" class="btn text-white" style="background-color:#010e2c;">Procesado</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    window.addEventListener('cellar_modal_hide', event => {
