<div>
    <!-- Modal -->
    <div wire:ignore.self class="modal fade " id="clientModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 1060;">
                    ...
                    <form class="form-horizontal form-bordered">
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <input type="text" name="name_client" class="form-control form-control-lg" placeholder="Nombre Cliente" wire:model="name_client" />
                            ...
                            <div class="col-lg-9">
                                <div class="row row-space-10">
                                    <div class="col-xs-6 mb-2 mb-sm-0">
                                        <input data-toggle="number" data-placement="after" class="form-control" type="number" name="id_card" id="id_card" placeholder="Número Identificación" minlength="9" maxlength="12" wire:model="id_card" />
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <div class="row row-space-6">
                                    <div class="col-4">
                                        <select class="form-control" name="id_province" id="id_province" wire:click="changeProvince()" wire:model="id_province">
                                    ...
                                    <div class="col-4">
                                        <select class="form-control" data-parsley-required="true" name="id_canton" id="id_canton" wire:click="changeCanton()" wire:model="id_canton">
                        ...
                        <div class="form-group row m-b-10">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <input type="text" name="other_signs" data-parsley-required="true" class="form-control" wire:model="other_signs" placeholder="Dirección exacta" />
                                @error('other_signs') <span class="text-red-500">{{ $message }}</span>@enderror
                            </div>
                        </div>
                        <!-- begin form-group -->
                        <div class="form-group row m-b-10">
                            <label class="col-lg-3 col-form-label">Correo: 44<span class="text-danger"></span></label>
                            <div class="col-lg-9 col-xl-9">
                        ...
                        <!-- begin form-group -->
                        <div class="form-group row m-b-10">
                            <label class="col-lg-3 col-form-label">Código de pais y Teléfono: </label>
                            <div class="col-lg-9 col-xl-9">
                                <div class="row row-space-6">
                                    <div class="col-6" wire:ignore>
                                        <select class="country-code-select2 form-control" name="id_country_code" id="id_country_code">
                        ...
                        <!-- end form-group -->
                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label">Condición de venta, Plazo y Monto de crédito: <span class="text-danger"></span></label>
                            <div class="col-lg-9">
                                <div class="row row-space-10">
                                    <div class="col-md-4">
                                    ...
                                    <div class="input-group col-xs-4 mb-2 mb-sm-0">
                                        <div class="input-group-prepend"><span class="input-group-text">días</span></div>
                            ...
                            <div class="col-lg-9">
                                <div class="row row-space-10">
                                    <div class="col-xs-6" wire:ignore>
                                        <select class="currency-select2 form-control" name="id_currency" id="id_currency" style="z-index: 2061;">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            $('.modal').on('shown.bs.modal', function() {
                $(".currency-select2").select2({
                    dropdownParent: $('#clientModal .modal-content')
                });
                $("#id_currency").on('change', function(e) {
                    @this.set('id_currency', e.target.value);
                });
                $(".country-code-select2").select2({
                    dropdownParent: $('#clientModal .modal-content')
                });
                $("#id_country_code").on('change', function(e) {
                    @this.set('id_country_code', e.target.value);
                });
            });
        });
    </script>
    <script>
        window.addEventListener('client_modal_hide', event => {
