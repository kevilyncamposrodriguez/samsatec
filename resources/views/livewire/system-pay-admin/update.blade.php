<!-- Modal -->
<div wire:ignore.self class="modal fade " id="editChargeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="invoice-header p-t-10 p-b-10 row">
                        ...
                        <div class="invoice" style="width: 100%;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" {{ ($ridivi != '')?'':'hidden' }}>
                                    <strong>referencia Ridivi:</strong>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="ridivi" wire:model="ridivi">
                                    </div>
                                </div>
                                <div class="col-md-6" {{ ($ridivi != '')?'':'hidden' }}>
                                    <strong>Fecha pago:</strong>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="ridivi_date" wire:model="ridivi_date">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="update()" onclick="this.disabled=true;" class="btn btn-primary close-modal">Guardar</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    window.addEventListener('editCharge_modal_hide', event => {
