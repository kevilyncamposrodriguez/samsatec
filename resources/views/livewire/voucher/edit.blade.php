<!-- Modal -->
<div wire:ignore.self class="modal modal-message fade" id="electronicPurchaseModalU" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="invoice-header">
                            <div class="invoice-from">
                                <address class="m-t-5 m-b-5">
                                    ...
                                    <select class="form-control" name="id_mh_categoryU" id="id_mh_category" wire:model="id_mh_category">
                            ...
                            <div class="invoice-to">
                                <address class="m-t-5 m-b-5">
                                    ...
                                    <select class="form-control" name="number_ea" id="number_eaU" wire:model="number_ea">
                        ...
                        <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                            ...
                            <div class="panel-body panel-form">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3" {{ ($type_line != 'Compra' && Auth::user()->currentTeam->plan_id != '1')?'':'hidden' }}>
                                    ...
                                    <div class="{{ (Auth::user()->currentTeam->plan_id == 1)?'col-lg-6':'col-lg-3' }}" {{ ($type_line == 'Compra')?'hidden':'' }}>
                                        <label class="col-md-12 col-form-label">Productos o Servicio</label>
...
<script>
    window.addEventListener('electronicPurchaseU_modal_hide', event => {
        $('#electronicPurchaseModalU').modal('hide');
    });
