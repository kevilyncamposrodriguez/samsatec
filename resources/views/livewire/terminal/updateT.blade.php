            ...
            <div class="modal-body">
                <form class="form-horizontal form-bordered">
                    ...
                    <div class="form-group row m-b-10">
                        ...
                        <div class="col-3">
                            <input data-toggle="number" data-placement="after" disabled="true" class="form-control" type="number"  name="number" wire:model="number"  placeholder="Número"  data-parsley-required="true"  />
                        </div>
                            ...
                            <div class="row row-space-6">
                                ...
                                <div class="col-4">
                                    <select class="form-control" data-parsley-required="true" name="id_canton" id="id_canton" wire:model="id_canton">                                                               
                                        <option style="color: black;" value="0" >Cantón</option>
                    ...
                    <div class="form-group row m-b-10">
                        ...
                        <div class="col-lg-9 col-xl-9">
                            <div class="row row-space-6">
                                ...
                                <div class="col-6">
                                    <input data-toggle="number" data-placement="after" class="form-control" type="number"  name="phone" wire:model="phone" placeholder="N. Telefónico" minlength="8" maxlength="8" />
                                </div>
                            </div>
