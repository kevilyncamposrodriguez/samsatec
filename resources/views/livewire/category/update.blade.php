...
<!-- Modal -->
<div wire:ignore.self class="modal fade" id="categoryUModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Actualización de Categoría</h5>
...
<script>
    window.addEventListener('categoryU_modal_hide', event => {
        $('#categoryUModal').modal('hide');
    });
</script>
