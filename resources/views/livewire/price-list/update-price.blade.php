<!-- Modal -->
<div wire:ignore.self class="modal fade" id="priceListModalU" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Modificar lista de precios</h5>
            ...
            <div class="modal-body">
                <form class="form-horizontal form-bordered">
                    ...
                    <!-- begin form-group -->
                    <div class="form-group row m-b-10">
                        <label class="col-lg-6 col-form-label">Descripcion: <span class="text-danger"></span></label>
...
<script>
    window.addEventListener('priceListU_modal_hide', event => {
        $('#priceListModalU').modal('hide');
    });
</script>